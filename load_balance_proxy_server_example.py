...
class ProxyState:
    ...
    def recode_timestamp(self, request_id: str, step_index: int):
...
async def _handle_select_instance(api: str, req_data: Any,
    ...
    proxy_state.recode_timestamp(request_id, 1)  # proxy_to_prefill
    ...
    proxy_state.recode_timestamp(request_id, 2)  # prefill_to_proxy
...
async def _handle_completions(api: str, request: Request):
    ...
    try:
        ...
        proxy_state.recode_timestamp(request_id, 0)  # user_to_proxy
        ...
        async def generate_stream():
            ...
            try:
                ...
                proxy_state.recode_timestamp(request_id, 3)  # proxy_to_decode
                while retry:
                    retry = False
                    async for chunk in stream_service_response_with_retry(
                        ...
                        yield chunk
                proxy_state.recode_timestamp(request_id, 4)  # decode_to_proxy
            except Exception as e:
                logger.error(
